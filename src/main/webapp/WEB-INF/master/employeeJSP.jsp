...
<head>
    ...
    var flag =false;
        $(document).ready(function () {
            ...
            var source =
            {
                ...
                updaterow: function (rowid, rowData, commit) {
                	if(flag==true){
	                	...
	                	if (rowData.employeeId != "" || rowData.employeeId != null){
	                        jsonToBeSend["employeeId"] = rowData.employeeId;
	                       }
	                       jsonToBeSend["firstName"] = rowData.firstName;
	                       jsonToBeSend["middleName"] = rowData.middleName;
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                pagerButtonsCount: 8,
                columns: [
                  { text: 'EmployeeId', datafield: 'employeeId', columntype: 'textbox', editable:false },
                  { text: 'First Name', datafield: 'firstName', columntype: 'textbox' },
                  { text: 'Middle Name', datafield: 'middleName', columntype: 'textbox'},
                  { text: 'Last Name', datafield: 'lastName', columntype: 'textbox'},
                  { text: 'Email Id', datafield: 'emailId', columntype: 'textbox'},
                  { text: 'Gender', datafield: 'gender', columntype: 'textbox'},
                  { text: 'Branch', datafield: 'branchId', columntype: 'textbox'},
                  { text: 'Status', datafield: 'status', filtertype: 'checkedlist', filteritems: ['Inactive', 'Active'], columntype: 'custom',width: "10",
                  ...
                  {
                	  text: 'Edit',filterable:false, align: "center", editable: false, sortable: false, datafield: '',width:'200px', cellsrenderer: function (row, column, value) {
    ...
    <script type="text/javascript">
                    ...
                    function Cancel(row, event) {
                        ...
                        var value = $("#jqxgrid").jqxGrid('getcellvalue', row, 'employeeId');
                        if (value == null) {
