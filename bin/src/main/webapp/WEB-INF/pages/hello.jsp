...
<head>
    <title>This example shows how to create a Grid from JSON string.</title>
    ...
    <script type="text/javascript" src="<c:url value='/jqwidgets/jqxdata.js'/>"></script> 
    <script type="text/javascript" src="<c:url value='/scripts/demos.js'/>"></script>
